...
sim = wsp.Simulator(
        ...
        title="LoraTree")
# place nodes
sim.add_node(LoraSink,(250,250),.4)
sim.add_node(LoraSink,(750,250),.4)
sim.add_node(LoraEDNode,(50,50),.4)
sim.add_node(LoraEDNode,(150,250),.4)
sim.add_node(LoraEDNode,(500,100),.4)
sim.add_node(LoraEDNode,(520,300),.4)
sim.add_node(LoraEDNode,(500,400),.4)
sim.add_node(LoraEDNode,(1000,200),.4)
sim.add_node(LoraEDNode,(1000,300),.4)
